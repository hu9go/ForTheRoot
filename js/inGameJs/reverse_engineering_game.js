document.addEventListener("DOMContentLoaded", function () {
  ...
  signIn((username, password) => {
    ...
    if (
      ...
      credenziali[0][1] ===
        usernamePassword[2].find((user) => user.username === usernameRequired)
          .password
    ) {
  ...
  setupReverse0 = () => {
    main.innerHTML = `
        <form id="resultForm">
        <pre>Ispeziona la pagina, analizza il pezzo di codice in js nel "main" e cracca la password. <br>Tieni d'occhio il <u>console</u></pre>
        <div id="result-group">
